"""
Pima Indians Diabetes Dataset – Zbiór 1 (dane z MLmastery, plik primaIndiansDiabets.csv).
...
Instrukcja użycia:
    1. Umieść plik primaIndiansDiabets.csv w tym samym katalogu co skrypt.
...
def load_pima_web(csv_path: str):
    """
    Wczytuje dane Pima ze Zbioru 1 z pliku primaIndiansDiabets.csv.
...
def main():
    ...
    X, y = load_pima_web("primaIndiansDiabets.csv")
